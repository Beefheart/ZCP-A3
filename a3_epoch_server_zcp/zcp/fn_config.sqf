...
ZCP_WeaponReward = ["LMG_Zafir_F","Machinegun_arifle_MX_SW_F","arifle_MX_SW_Black_F","1911_pistol_epoch","arifle_TRG21_F"]; // Classname in an array in the reward array for weapons
